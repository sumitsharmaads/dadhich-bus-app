...
export const metadata: Metadata = {
  ...
  description:
    "Premium bus rental services for local and outstation travel. Luxury coaches, professional drivers, and reliable transportation solutions.",
  keywords:
    "bus rental, luxury bus service, outstation bus rental, local bus rental, corporate bus service",
  openGraph: {
    title: "Bus Rental Services | Dadhich Bus Services",
    description: "Premium bus rental services for all your travel needs.",
    type: "website",
    url: "https://dadhichbus.com/services",
  },
};
            ...
            {[
              {
                ...
                title: "Contact Us",
                description:
                  "Call us at +91 9511547154 or fill our online booking form",
              },
              {
                step: "02",
                title: "Get Quote",
